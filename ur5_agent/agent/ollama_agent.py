...
OLLAMA_AGENT_HINT = (
    ...
    "Left/right/forward/back use move_left/move_right/move_forward/move_backward (straight TCP moveL, all joints coordinated). "
    "Up/down use move_up and move_down (base Z). distance_m is meters (20 cm = 0.20). "
